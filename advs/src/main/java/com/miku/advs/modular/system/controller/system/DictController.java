...
import com.miku.advs.core.common.constant.dictmap.DictMap;
...
import com.miku.advs.modular.system.model.DictDto;
import com.miku.advs.modular.system.service.system.DictService;
import com.miku.advs.modular.system.warpper.DictWarpper;
...
public class DictController extends BaseController {
     ...
     * @Date 2018/12/23 5:22 PM
     */
    @BussinessLog(value = "删除字典记录", key = "dictName", dict = DictMap.class)
