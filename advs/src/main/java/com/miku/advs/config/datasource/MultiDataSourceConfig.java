 ...
 */
package com.miku.advs.config.datasource;
...
import com.miku.advs.config.properties.ThirdDataSourceProperties;
...
@MapperScan(basePackages = {"com.miku.advs.modular.*.mapper", "com.miku.advs.multi.mapper"})
public class MultiDataSourceConfig {
    ...
    public ThirdDataSourceProperties thirdDataSourceProperties() {
        return new ThirdDataSourceProperties();
    }
     ...
     *  第三个数据源
     */
    private DruidDataSource thirdDataSource(DruidProperties druidProperties, MutiDataSourceProperties mutiDataSourceProperties,ThirdDataSourceProperties thirdDataSourceProperties) {
        DruidDataSource dataSource = new DruidDataSource();
        druidProperties.config(dataSource);
        mutiDataSourceProperties.config(dataSource);
        thirdDataSourceProperties.config(dataSource);
        return dataSource;
    }
     ...
     */
    @Bean
    public DynamicDataSource mutiDataSource(DruidProperties druidProperties, MutiDataSourceProperties mutiDataSourceProperties,ThirdDataSourceProperties thirdDataSourceProperties) {
        ...
        DruidDataSource thirdDataSource = thirdDataSource(druidProperties,mutiDataSourceProperties,thirdDataSourceProperties);

        try {
            dataSourceGuns.init();
            bizDataSource.init();
            thirdDataSource.init();
        ...
        hashMap.put(DatasourceEnum.DATA_SOURCE_ALL,thirdDataSource);
