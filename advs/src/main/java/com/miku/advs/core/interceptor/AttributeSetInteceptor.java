 ...
 */
package com.miku.advs.core.interceptor;
...
import com.miku.advs.core.util.DefaultImages;
...
public class AttributeSetInteceptor extends HandlerInterceptorAdapter {
    ...
    public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler, ModelAndView modelAndView) throws Exception {
        ...
        if (user == null) {
            ...
            modelAndView.addObject("roleName", ConstantFactory.me().getSingleRoleName(Long.parseLong(user.getRoleId())));
