...
public interface IConstantFactory {
    ...
    String getHostName(Integer advertiserId);

    String getChannelName(Integer channelId);

    Object getDomainName();

    String getPartnerNameById(Integer partnerId);

    Advertise getAdvertiseById(String advertiseId);

    Channel getChannelById(Integer channelId);

    Integer getActiveUserCount(Integer channelId, String date);

    Object  getDomainsName();

    ChannelSub getChannelSubById(Integer cid);

    String getPackageName(Integer packageId);

    Map<Integer, String> getSystemVersionList();
